...
![ARP 攻击](../.gitbook/assets/ARP攻击.png)
...
![ARP 报文格式](../.gitbook/assets/2019-12-14\_202044.png)
...
![没有运行 send_arp 之前，A 的 ARP 缓存](../.gitbook/assets/2019-12-14\_210821.png)

A 发送给 B 的消息能够正常送达。

![A 与 B 正常通信](../.gitbook/assets/2019-12-14\_210418.png)

在主机 B 上运行 send_arp 之后，A 的 ARP 缓存发生了变化：

![在主机 B 上运行 send_arp 之后，A 的 ARP 缓存发生了变化](../.gitbook/assets/2019-12-14\_211301.png)

而且 A 发送给 B 的消息也无法送达了。

但是如果这个时候你在 C 上运行 UDP 服务端，你会发现 C 也收不到 A 发送的消息。

![C 也收不到 A 发送的消息](../.gitbook/assets/2019-12-14\_212520.png)
...
![TCPIP 四层网络模型](../.gitbook/assets/TCPIP四层网络模型.png)

C 接受到的 A 发送过来的消息结构大概是这样的：

![C 收到的消息格式](../.gitbook/assets/C收到的消息格式.png)
...
![主机 C 接收数据](../.gitbook/assets/2019-12-15\_004108.png)
